...
set(gcf, 'color', 'white'); set(gca, 'color', 'white', 'XColor', 'black', 'YColor', 'black', 'ZColor', 'black');
scatter3(P.spls(:, 1), P.spls(:, 2), P.spls(:, 3), 200, '.', 'red');
xlabel('x-axis'); ylabel('y-axis'); zlabel('z-axis'); grid on; axis equal;
...
set(gcf, 'color', 'white'); set(gca, 'color', 'white', 'XColor', 'black', 'YColor', 'black', 'ZColor', 'black');
scatter3(P.spls(:, 1), P.spls(:, 2), P.spls(:, 3), 200, '.', 'red');
plot_connectivity(P.spls, P.spls_adj, 2, [0, 0, 1]);
xlabel('x-axis'); ylabel('y-axis'); zlabel('z-axis'); grid on; axis equal;
...
start = 0;
figure('Name', 'Primary branch')
pcshow(P.branch_pc, 'MarkerSize', 20); hold on
set(gcf, 'color', 'white'); set(gca, 'color', 'white', 'XColor', 'black', 'YColor', 'black', 'ZColor', 'black');
...
figure('Name', 'Refined main trunk skeleton')
set(gcf, 'color', 'white'); set(gca, 'color', 'white', 'XColor', 'black', 'YColor', 'black', 'ZColor', 'black');
plot3(refined_main_trunk_pts(:, 1), refined_main_trunk_pts(:, 2), refined_main_trunk_pts(:, 3), '.r', 'MarkerSize', 30);
xlabel('x-axis'); ylabel('y-axis'); zlabel('z-axis'); grid on; axis equal;
...
xlabel('x-axis'); ylabel('y-axis'); grid on; axis equal;

%% bottom primary branch
roi = [-0.2, 0.2, -0.05, 0.4, P.branch_pc.ZLimits(1), P.branch_pc.ZLimits(1)+0.12];
...
roi = [-0.2, 0.2, -0.05, 0.4, P.trunk_pc.ZLimits(1), P.branch_pc.ZLimits(1)+0.2];
...
set(gcf, 'color', 'white'); set(gca, 'color', 'white', 'XColor', 'black', 'YColor', 'black', 'ZColor', 'black');
plot3(primary_branch_pts(:, 1), primary_branch_pts(:, 2), primary_branch_pts(:, 3), '.', 'Color', 'yellow', 'MarkerSize', 30);
