...
if (bUpdateConnectivity)
    [P.spls, P.spls_density, P.corresp] = farthest_sampling_by_sphere(P.cpts, P.density, P.sample_radius);
    P.spls_adj = connect_by_inherit_neigh(P.cpts, P.spls, P.corresp, P.rings);    
    [P.spls, P.removed_spls, P.spls_density, P.spls_adj, P.corresp] = edge_collapse_update(P.cpts, P.spls, P.spls_density, P.corresp, P.rings, P.spls_adj, options);
else
    [P.spls, P.spls_density, P.corresp] = farthest_sampling_by_sphere(P.cpts, P.density, P.sample_radius);
    P.spls_adj = connect_by_inherit_neigh(P.cpts, P.spls, P.corresp, P.rings);
    [P.spls, P.removed_spls, P.spls_density, P.spls_adj, P.corresp] = edge_collapse(P.cpts, P.spls, P.corresp, P.rings, P.spls_adj, options);
end
